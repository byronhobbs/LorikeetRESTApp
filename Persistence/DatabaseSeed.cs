    ...
    public class DatabaseSeed
    {
        public static void Seed(AppDbContext context, IPasswordHasher passwordHasher)
        {
            ...
            if (context.Users.Count() == 0)
            {
                ...
                {
                    new User { Email = "admin@lorikeet.org.au", Password = passwordHasher.HashPassword("admin") },
                    new User { Email = "lorikeet@lorikeet.org.au", Password = passwordHasher.HashPassword("lorikeet123") }
                };
